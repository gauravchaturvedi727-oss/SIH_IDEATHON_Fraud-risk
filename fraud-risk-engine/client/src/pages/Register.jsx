...
function Register() {
  ...
  // State to manage Welcome Screen -> Unlocking -> Register Form
  const [stage, setStage] = useState("welcome"); // "welcome" | "unlocking" | "registered_view"
  ...
  const handleStartRegistration = () => {
    ...
    }, 1800); // 1.8s for biometric unlock sequence
  };
  ...
  return (
    <div className={`register-page ${stage}`}>
      {/* 3D Rotating Cyber Earth & Data Accretion Vortex */}
      ...
      {stage === "welcome" && (
        <section className="welcome-portal">
          ...
          <button className="welcome-btn" onClick={handleStartRegistration}>
      ...
      {/* ================= STAGE 2: UNLOCKING SCANNER ================= */}
      {stage === "unlocking" && (
        <div className="unlock-scanner-overlay">
          <div className="scanner-reticle"></div>
          <h2>[ INITIALIZING DHANRAKSHAK SECURITY SHIELD ]</h2>
          <p>SCANNING IDENTITY CODES & SECURING PROTOCOLS...</p>
        </div>
      )}

      {/* ================= STAGE 3: REGISTRATION HUD ================= */}
      {stage === "registered_view" && (
        <div className="register-container">
          {/* Left Panel: Telemetry & Security Features */}
          <section className="register-info">
            ...
            <div className="register-info-content">
              <div className="register-badge">
                <span></span> CYBER IDENTITY CLEARANCE
              </div>
          ...
          <section className="register-card">
            <div className="register-card-header">
              <span className="register-small-label">NEW AGENT REGISTRATION</span>
              <h2>Create Security Account</h2>
              <p>Enter your details to initiate your DhanRakshak identity.</p>
            </div>
            ...
            <div className="register-secure">
              🔐 256-Bit Quantum Encrypted DhanRakshak Vault
            </div>
          </section>
        </div>
      )}
